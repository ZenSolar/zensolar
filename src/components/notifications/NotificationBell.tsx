  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {totalCount > 0 && (
          <span data-capture-hide className="absolute -top-0.5 -right-0.5 h-4 w-4 rounded-full bg-destructive text-destructive-foreground text-[10px] flex items-center justify-center font-bold">
