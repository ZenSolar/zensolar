...
export const HUB_CARDS: HubCardDef[] = [
  ...
  },
  {
    id: "the-ask",
    to: "/founders/the-ask",
    eyebrow: "Pre-Meeting · Q2",
    title: "The Ask — Lyndon",
    blurb: "Board seat — co-shape the tokenized energy economy from day one. Why a seat, not a check.",
    icon: Banknote,
    tone: "amber",
    createdAt: "2026-05-11",
  },
  {
    id: "current-status",
    to: "/founders/current-status",
    eyebrow: "Pre-Meeting · Q3",
    title: "Current Status — Live & Shipping",
    blurb: "Live on Base L2 with real on-chain mints, 4 OEM rails, SEGI™ patent + 5 trademarks filed.",
    icon: Activity,
    tone: "eco",
    createdAt: "2026-05-11",
  },
  {
    ...
    eyebrow: "Round One · $5M Seed",
    title: "Seed Ask — Lyndon",
    blurb: "Standalone one-pager for the lead-investor conversation. v8.1.",
    icon: Banknote,
    tone: "amber",
    createdAt: "2026-04-29",
  },
