...
export const HUB_CARDS: HubCardDef[] = [
  ...
  {
    id: "jo-brief",
    to: "/founders/jo-brief",
    eyebrow: "Pre-Meeting · Jo Fertier",
    title: "Jo Fertier — Lyndon Brief",
    blurb: "Answers Jo's 3 pre-meeting questions: competitive landscape, the ask, live traction. PDF + page.",
    icon: FileText,
    tone: "primary",
