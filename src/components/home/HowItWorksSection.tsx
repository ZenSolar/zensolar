...
const steps = [
  ...
  },
  {
    ...
    description: 'Rewards and achievement NFTs are minted directly to your wallet. No manual claiming, no gas fees, no friction. Pro and Elite subscribers earn every day.',
    color: 'text-solar',
    bg: 'bg-solar/10',
  ...
  },
  {
    ...
    description: 'Your rewards and NFTs are held securely in your embedded ZenSolar wallet. No external wallets or browser extensions needed. Cash out whenever you\'re ready.',
    color: 'text-token',
    bg: 'bg-token/10',
