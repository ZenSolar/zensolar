        ...
        <div className="grid grid-cols-3 gap-5 mb-10">
          {[
            ...
            },
            {
              ...
              stat: '1T cap · 50 user · 20 LP · 20 burn · 10 treasury',
              desc: 'Core product and primary long-term revenue driver. 1T hard cap. Every verified kWh shows 1:1 in the user\'s wallet, and the protocol matches it 1-for-1 in the background — 20% LP, 20% burn, 10% treasury. Every mint deepens liquidity and tightens supply in the same transaction.',
              color: 'hsl(45,93%,47%)',
              emphasized: true,
            },
            {
