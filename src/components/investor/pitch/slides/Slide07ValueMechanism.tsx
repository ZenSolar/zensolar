    ...
    <SlideLayout variant="dark">
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-16 pt-20 pb-16">
        ...
        <div className="grid grid-cols-3 gap-6">
          {[
            { title: 'Burns Reduce Supply', desc: '20% mint burn permanently destroys tokens with every verified kWh. A separate 3% transfer tax recycles into LP on every sale.', color: 'hsl(0,84%,60%)' },
            { title: 'Subscriptions + Mints Add Reserve', desc: '50% of every sub dollar AND 25% of every mint flow straight into the USDC liquidity pool — every verified kWh deepens the floor.', color: 'hsl(207,90%,54%)' },
