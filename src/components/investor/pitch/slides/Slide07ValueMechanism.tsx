      ...
      <div className="absolute inset-0 flex flex-col justify-center px-16 pt-20 pb-16">
        ...
        <div className="grid grid-cols-3 gap-6">
          {[
            ...
            { title: 'Subscriptions + Mints Add Reserve', desc: '50% of every sub dollar AND 20% of every mint flow straight into the USDC liquidity pool — every verified kWh deepens the floor.', color: 'hsl(207,90%,54%)' },
