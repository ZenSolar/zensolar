...
export const SCENE_ANCHORS = Object.freeze({
  ...
  homeWallStub:  { x: 69.3, y: 56.7 } as Pt,
  /** Powerwall cabinet, level with the panel. */
  powerwall:     { x: 33.8, y: 46.3 } as Pt,
