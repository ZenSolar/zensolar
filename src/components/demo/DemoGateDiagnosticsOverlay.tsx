...
export function DemoGateDiagnosticsOverlay({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-2 bottom-2 z-[9999] flex justify-center">
      <section className="w-full max-w-sm rounded-xl border border-border/70 bg-background/95 px-2.5 py-2 shadow-[0_18px_48px_hsl(var(--foreground)/0.16)] backdrop-blur-md">
