  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <Badge className="w-fit bg-primary/10 text-primary border-primary/30 mb-2">
            <Sparkles className="h-3 w-3 mr-1" />
            One-time event
          </Badge>
          <DialogTitle className="text-2xl">{GENESIS_HALVING.publicName} is coming</DialogTitle>
