      ...
      <div className="container max-w-4xl mx-auto px-4 space-y-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg leading-relaxed">
            ...
            and milestone NFTs with just one tap—backed by the <strong className="text-primary">Device Watermark Registry</strong>, an on-chain standard that makes double-minting provably impossible.
          </p>
