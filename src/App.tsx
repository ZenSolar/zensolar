                  ...
                  <Suspense fallback={<PageLoader />}>
                   ...
                   <Route path="/seed/data-room" element={<Navigate to="/seed/ip" replace />} />
                    ...
                    {([
                      ...
                      { slug: 'founders-the-ask', model: 'The Ask (Lyndon $5M / board seat)', Comp: FoundersTheAsk, reason: 'Stale raise framing — current ask is $1M target / $2M hard cap at /investor/pitch' },
                      { slug: 'founders-seed-allocation', model: 'Seed Allocation (editable $5M one-pager)', Comp: FoundersSeedAllocation, reason: 'Stale $5M / $0.25-launch numbers — canonical raise ($1M target / $2M hard cap) lives at /investor/pitch' },
