        ...
        <article className="prose prose-invert max-w-none space-y-10 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <div className="rounded-lg border border-border bg-muted/10 p-5 space-y-3 font-mono text-[13px] leading-relaxed">
              ...
              <div><span className="text-amber-400">[5] Proportional Mint</span> &rarr; contract mints <code>units × rate</code> tokens, applies 50/25/20/5 split atomically.</div>
          ...
          <section className="border-t border-border pt-6 text-xs text-muted-foreground">
            ...
            (1T cap · $0.10 launch · 50/25/20/5). Subject to revision.
          </section>
        </article>
      </div>
    </div>
