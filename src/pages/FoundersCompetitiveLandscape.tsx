      ...
      <section className="max-w-5xl mx-auto px-5 md:px-6 pb-10">
        <div className="rounded-2xl border-2 border-primary/40 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-6 md:p-8">
          ...
          <div className="space-y-3 text-sm md:text-base text-muted-foreground leading-relaxed">
            ...
            <p>
              That's why this is a new asset class, not a new coin: <span className="text-foreground font-semibold">the unit of account is a verified physical event</span>, not a pre-minted pool, not a yield wrapper, not a hardware subsidy. Bitcoin tokenized computational work. We tokenize clean energy work — and we did it with a 1T hard cap, a treasury-share step-down, founders pact-locked, and patent-pending verification IP (Proof-of-Genesis, Proof-of-Delta, Proof-of-Origin, Mint-on-Proof).
            </p>
            <p>
      ...
      <section className="max-w-5xl mx-auto px-5 md:px-6 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <ReasonCard
            ...
            us="Mint-on-Proof — tokens only come into existence when verified energy flows. 1T hard cap, treasury-share step-down, founders pact-locked."
          />
          <ReasonCard
            icon={TrendingUp}
            label="Moat"
