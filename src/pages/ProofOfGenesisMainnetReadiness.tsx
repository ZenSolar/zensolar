...
const MAINNET_GROUPS: Group[] = [
  ...
  },
  {
    ...
    icon: Coins,
    intro:
      'The token + LP machinery lives behind the same env flip. Hard cap 1T, mint split 75/20/3/2 already wired in tokenomics.ts.',
    items: [
      {
      ...
      },
      {
        ...
        detail: 'Surfaced on /admin/contracts and on the public /tokenomics page so the 75/20/3/2 split is independently auditable.',
        state: 'todo',
      },
    ],
  },
