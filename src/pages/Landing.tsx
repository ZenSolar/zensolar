        ...
        <div className="container max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <div className="text-[clamp(1.05rem,3vw,1.25rem)] text-muted-foreground max-w-xl mx-auto leading-relaxed text-center">
              <p className="mb-4">
                ZenSolar rewards your clean energy lifestyle with <span className="text-primary font-semibold">$ZSOLAR tokens</span> and <span className="text-primary font-semibold">NFTs</span> for:
              </p>
