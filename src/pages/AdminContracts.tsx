...
const CONTRACTS = {
  ZSOLAR: {
    ...
    symbol: 'ZSOLAR',
    type: 'ERC-20',
    address: '0x9bcf687eee0AF5f8C81F69812E3d7aC2cfCe410E',
  ...
  ZenSolarNFT: {
    ...
    symbol: 'ZSNFT',
    type: 'ERC-1155',
    address: '0x63ef4BEF238a1E91740dA5aB11Ae1E7D319EFC4C',
    network: 'Base Sepolia',
    chainId: 84532,
  },
  ZenSolar: {
    ...
    symbol: 'Controller',
    type: 'Controller',
    address: '0x3763B402b7f3Bd407B5141C55C94a1076f220cE7',
    network: 'Base Sepolia',
    chainId: 84532,
  },
};
...
const TOKENOMICS = {
  ...
  // No burn at mint — v4.0 split: 1.0 member / 0.25 treasury
  mintDistribution: {
    user: 50,
    lp: 20,
    burn: 20,
