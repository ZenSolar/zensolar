  ...
  return (
    ...
    >
      ...
      <p>
        ...
        just passive income on top of your existing solar savings.
      </p>
      ...
      <ol>
        ...
        <li><strong>Proof-of-Delta verification</strong> — Our patent-pending system verifies real energy deltas, not estimates</li>
      ...
      <p>
        ...
        into a token-earning opportunity.
      </p>
      ...
      <p>
        ...
        $ZSOLAR tokens in under two minutes. Create your ZenSolar account, connect your Tesla
        account, and your rewards begin accruing immediately.
      </p>
    </BlogArticle>
  );
}
