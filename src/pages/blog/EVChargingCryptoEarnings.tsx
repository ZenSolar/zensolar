  ...
  return (
    ...
    >
      ...
      <p>
        ...
        for their contribution to the clean energy transition.
      </p>
      ...
      <p>
        ...
        verified through real vehicle API data from Tesla, Wallbox, and other supported providers.
      </p>
      ...
      <ul>
        <li><strong>Tesla</strong> — Full integration via Tesla Fleet API (Model S, 3, X, Y, Cybertruck)</li>
      ...
      <p>
        ...
        Imagine: your solar panels produce energy (earning tokens), your battery stores and
        discharges (earning tokens), and your EV charges from solar and drives clean miles
        (earning tokens). Every link in the chain generates rewards.
      </p>

      <h2>Getting Started</h2>
      <p>
        If you drive an EV, you can start earning $ZSOLAR today. Connect your vehicle account
        to ZenSolar and your charging sessions and miles driven automatically translate into
