...
import { Loader2, KeyRound, Delete, Check, ShieldAlert, ArrowRight, Zap, Network, Clock } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[hsl(220,20%,6%)] text-white">
      ...
      <div className="mx-auto max-w-[1280px] px-6 md:px-10 py-12 md:py-16">
        ...
        <p className="text-[14px] font-mono tracking-[0.28em] uppercase text-secondary/80 mb-4">
...
export default function InvestorDataRoom() {
  ...
  if (unlocked) return <DataRoomContent />;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[hsl(220,20%,6%)] text-white">
      <Helmet>
        <title>ZenSolar — Investor Data Room (PIN required)</title>
        <meta name="robots" content="noindex,nofollow" />
        <link rel="canonical" href="https://www.zensolar.com/investor/data-room" />
      </Helmet>
