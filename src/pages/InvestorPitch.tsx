...
import { ArrowLeft, PlayCircle, Calendar, Sparkles } from 'lucide-react';
        ...
        <section className="mx-auto max-w-3xl px-5 py-12 border-t border-border/40">
          ...
          <div className="rounded-3xl border border-border/60 bg-card/40 p-6 md:p-8">
            <p className="text-sm md:text-base text-foreground/90 leading-relaxed">
              ...
              — both ex-SolarCity, both operators, both still in seat. 200B $ZSOLAR pact-locked
              between the two founders. 9-jurisdiction legal posture, OEM telemetry live, 3.34M+
              verified kWh through the protocol to date.
            </p>
            <ul className="mt-4 space-y-2 text-[13px] text-muted-foreground">
              <li className="flex gap-2">
                <span className="text-secondary mt-1.5 h-1 w-1 rounded-full shrink-0 bg-secondary" />
