...
BEGIN
  ...
  -- Explicit source_breakdown always wins.
  -- Legacy mint-rewards rows currently lack source_breakdown; those Clean Energy
  -- Center mints were Tesla Supercharging attribution, so do NOT infer Home
  -- Charging just because home_charging_sessions rows exist in the same window.
