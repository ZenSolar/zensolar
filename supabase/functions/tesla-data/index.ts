      ...
      try {
        ...
        if (cap === "ev") {
          ...
          return new Response(JSON.stringify({
            ...
            charge_miles_added_rated: cs.charge_miles_added_rated,
            charge_limit_soc: cs.charge_limit_soc,
            minutes_to_charge_limit: cs.minutes_to_charge_limit,
        ...
        if (site.pending_solar_wh > 0 || site.pending_battery_discharge_wh > 0) {
          ...
          await supabaseClient
            ...
            .upsert({
              ...
              provider: "tesla",
              production_wh: snapshotDelta(solarVal, solarPrevVal),
              data_type: "solar",
        ...
        if (site.lifetime_battery_discharge_wh > 0) {
          ...
          await supabaseClient
            ...
            .upsert({
              ...
              device_id: site.site_id,
              provider: "tesla",
              production_wh: snapshotDelta(battVal, battPrevVal),
      ...
      if (totalEvChargingKwh > 0 && vehicleDevices.length > 0) {
        ...
        await supabaseClient
          ...
          .upsert({
            ...
            provider: "tesla",
            production_wh: snapshotDelta(chargingWh, chgPrevVal),
        ...
        if (vehicle.odometer > 0) {
          ...
          await supabaseClient
            ...
            .upsert({
              ...
              provider: "tesla",
              production_wh: snapshotDelta(vehicle.odometer, prevOdometer),
              data_type: "ev_miles",
              recorded_at: recordedAt,
