...
Launch price (LP math) and kWh-floor (real-world utility+carbon+REC) are TWO INDEPENDENT mechanisms — never conflate. kWh floor is narrative-only at seed; on-chain Energy Oracle is parked for Series A.
Founders pact-locked: Joseph 150B, Michael 50B. $1T crossovers: $6.67 / $20.
**Halving every 4 years (Bitcoin-cadence). Epoch 1 mints 400B (40% of cap). 5 halvings inside 20-yr founder pact-lock. Net-deflationary by epoch 5.**
**5-layer Scarcity Stack: cap + burn-per-mint + 4yr halving + founder pact-lock + POL. Always cite all 5 together when explaining scarcity — never just one.**
ALL demo/preview/share URLs MUST use https://beta.zen.solar — NEVER lovable.app or lovable.dev domains.

## Memories
- [Halving Schedule (LOCKED)](mem://features/halving-schedule) — 4yr Bitcoin cadence, epoch table, math basis, why not 2/6/milestone
