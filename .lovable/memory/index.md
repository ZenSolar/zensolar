...
"Creating Currency From Energy". No crypto jargon. Use "Proof of Genesis™" (replaces retired "Tap-to-Mint™" term — see brand/naming.md).
Investor revenue engines (LOCKED Jun 2026): 01 Subscription + Token Economics (combined), 02 Deason AI ($4.99 premium add-on), 03 Aggregated Energy Data. Deason is always the upgrade, never standalone.
