...
## Core
**📜 SSoT: `mem://CANONICAL_SSOT.md` — read first, overrides everything below if conflict.**
...
Allocations: Community 70% (700B) / Joseph 15% (150B) / Michael 5% (50B) / Treasury 7.5% / Team 2.49% / Strategic Intros 0.01%.
Launch price $0.10 USDC. LP is **tranche-per-round, producer-gated**. OG round (users 0–1k) = $50K seed. NEVER "launch at $1".
Launch price (LP math) and kWh-floor (real-world utility+carbon+REC) are TWO INDEPENDENT mechanisms — never conflate. kWh floor is narrative-only at seed; on-chain Energy Oracle parked for Series A.
