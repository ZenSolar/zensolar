...
- LP receives **two separate monthly inflows**:
  ...
  2. ~~25% of newly minted tokens~~ REMOVED — there is no LP mint under v4.0 (1.0 member / 0.25 treasury)
...
- `src/pages/Ecosystem.tsx` — LP card shows both lines: "From subscriptions" + "From mint reflows". Never names mint-split percentages in customer copy.

## UI rule
- Never expose mint-split percentages or "X% to treasury" copy on customer screens.
