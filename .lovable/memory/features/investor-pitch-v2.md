...
2. **Token Economics** — core product and primary long-term revenue driver. 1T hard cap; mint split v4.0 issues 1.0 to the member and 0.25 to treasury per verified unit, with no LP mint and no burn at mint. A separate 3% transfer tax recycles to LP. Launch remains $0.10 LP-seeded on Base.
