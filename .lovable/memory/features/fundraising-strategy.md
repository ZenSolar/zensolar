...
2. **Token Economics** — core product and primary long-term revenue driver. 1T cap, 50/25/20/5 mint split (50% user · 25% LP direct · 20% burn · 5% treasury), $0.10 LP-seeded launch on Base, separate 3% transfer tax (LP recycle only) compounds liquidity + treasury yield perpetually.
