---
name: Fundraising Strategy (Strategic Seed)
description: Round shape, ask, valuation, anchor strategy, investor map, and process for the active raise
type: feature
---
...
2. **Token Economics** — core product and primary long-term revenue driver. 1T cap, mint split v4.0 (1.0 member · 0.25 treasury = 1.25 per verified unit; no LP mint, no burn at mint), $0.10 LP-seeded launch on Base, separate 3% transfer tax (LP recycle only) compounds liquidity + treasury yield perpetually.
